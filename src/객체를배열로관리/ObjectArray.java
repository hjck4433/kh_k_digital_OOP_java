...
public class ObjectArray {
    public static void main(String[] args) {
        java.util.Scanner sc = new java.util.Scanner(System.in); // 이것도 가능
        System.out.println("입력 인원 : ");
        int cnt = sc.nextInt();
        NameCard[] nameCards = new NameCard[cnt]; // 입력 받은 인원 수 만큼 배열 크기 만들어짐
        ...
        for(NameCard card : nameCards) card.printInfo();
