package 입출력_성능향상보조스트림;

import java.io.*;

// 프로그램과 입출력 장치 사이에는 엄청난 속도 차이가 발생하며, 이로 인해서 병목현상이 발생합니다.
...
//        System.out.println("성능향상 보조 스트림을 사용하지 않은 경우 : " + (end-start) + "ms"); // 141ms
        ...
        System.out.println("성능향상 보조 스트림을 사용하는 경우 : " + (end-start) + "ms"); // 16ms
    }
}
